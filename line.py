...
color=["0","255","0"]
drawline(-30,-20,30,-20,color)
drawline(0,0,-50,100,color)
drawline(-50,100,100,50,color)
drawline(-50,-100,50,100,color)
drawline(-100,0,100,0,color)
drawline(0,-100,0,100,color)
drawline(0,0,100,-50,color)
drawline(0,0,50,-100,color)
